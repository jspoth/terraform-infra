...
variable "sqs_queue_prefix" {
  type        = string
  description = "Name prefix for SQS queues (e.g. 'dr'). Policy grants access to all queues matching <prefix>-*. Add queues in messaging/terraform.tfvars — no changes needed here."
  default     = "dr"
}
